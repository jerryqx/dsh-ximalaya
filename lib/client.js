  ...
  factory: (require) => {
    ...
    function MineTab() {
      ...
      return React.createElement('div', { className: 'xmly-tab-body xmly-mine-body' }, [
          ...
          s.loggedIn
            ? React.createElement('div', { key: 'u', className: 'xmly-user-row' }, [
                ...
                React.createElement('button', {
                  ...
                  onClick: async () => { await jsonPost('/dsh-ximalaya/logout', {}); set({ loggedIn: false, user: null }); showToast('已退出登录'); },
                }, '退出'),
              ])
        ...
        React.createElement('div', { key: 'favs', className: 'xmly-section-title' }, '♥ 我的收藏（' + s.favs.length + '）'),
        s.favs.length === 0
